...
module.exports = class Worker {
  ...
  run () {
    ...
    .then((spec) => {
      ...
      const out = Object.assign({}, this.job)
      out.inspectData.NetworkSettings.Ports = ports
      this.log.trace({ out }, 'XXX ports publish')
      publisher.publishEvent('container.network.attached', out)
    })
    .catch((err) => {
      // TODO: remove
